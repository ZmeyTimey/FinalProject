...
public class UserDAOImpl extends AbstractDAO implements UserDAO {
    ...
    private static final String IS_PASSWORD_CORRECT
            = "SELECT EXISTS(SELECT 1 FROM `users` WHERE `login`=?"
            + " AND `password`=?)";
...
//    }
    ...
    /**
     * Adds a new user to the data base. Returns the id
     * of this user generated by the data base.
     *
     * @param user
     *            the user
     * @return the id of added user
     * @throws DAOException
     *             the exception during getting connection with
     *             data base or during
     *             working with data base.
     */
    @Override
    public Integer addUser(final User user) throws DAOException {
    ...
    public boolean isPasswordCorrect(final String login,
        ...
        try {
            connection = connectionProvider.obtainConnection();
            statement = connection.prepareStatement(IS_PASSWORD_CORRECT);
